...
class rainTPL{
	...
	// -------------------------
		 ...
		 * @var array
		 */
		static $path_replace_list = array( 'img', 'input' );
	 ...
	 */
        function __construct($registry) {
            ...
            /*if(is_dir(self::tpl_dir))
            {
                echo "There is the TPL Dir!";
            }
            else
            {
                echo dirname(self::$tpl_dir);
            }*/
        }
	...
	*/
	...
	private function compileString( $template_code ){
		...
		//compile the code
		$compiled_code = $this->compileCode( $template_code );
                //var_dump($compiled_code);
		//return the compiled code
		echo  $compiled_code;

	}

function drawString( $string, $return_string = false ){
			...
			// compile the template if necessary			
                        ...
                        ob_start();
			//extract($this->var);
			//$this->compileCode($this->compileString($string));
			echo $this->compileString($string);
			$raintpl_contents = ob_get_clean();
			//if (ob_get_length()) $raintpl_contents = ob_end_clean();
			//var_dump($raintpl_contents);
            // return or print the template                        
            if( $return_string ) return $raintpl_contents; else echo $raintpl_contents;
